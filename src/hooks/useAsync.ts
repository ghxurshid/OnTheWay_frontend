...
interface AsyncState<T> { data: T | null; loading: boolean; error: unknown; reload: () => void }
 ...
 */
export function useAsync<T>(loader: () => Promise<T> | T, deps: unknown[] = [], initial: T | null = null): AsyncState<T> {
