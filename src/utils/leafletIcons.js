/* ════════════════════════════════════════════════════════════════
   ...
   registering L.polyline.antPath.
   ════════════════════════════════════════════════════════════════ */
...
export function makeMarkerIcon(color, label) {
...
export function makeAntPath(latlngs, opts) {
...
export function makeWalkerIcon(color, initials) {
  // Root stays 34×34 so the unread badge (anchored top-right of the root) keeps
  // its position; a transparent inset:-16 hitbox enlarges the tap/click target
  // to ~66px so walkers are far easier to hit, especially on touch.
  return L.divIcon({
...
export function makeStartIcon(color, theme) {
  return L.divIcon({
...
export function makeDestIcon(color, theme) {
