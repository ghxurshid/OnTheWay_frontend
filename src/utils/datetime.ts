...
/** 24h HH:MM. */
export const fmt12 = (d: Date): string => d.toLocaleTimeString('uz', { hour: '2-digit', minute: '2-digit', hour12: false });

/** Short "dd mon" date. */
export const fmtDate = (d: Date): string => d.toLocaleDateString('uz', { day: '2-digit', month: 'short' });
