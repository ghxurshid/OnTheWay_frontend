...
export const STRINGS = {
    ...
    mapui: {
      zoomIn: { uz: "Yaqinlashtirish", ru: "Приблизить", en: "Zoom in" },
      zoomOut: { uz: "Uzoqlashtirish", ru: "Отдалить", en: "Zoom out" },
      locating: { uz: "Joylashuv aniqlanmoqda…", ru: "Определяем местоположение…", en: "Finding your location…" },
      offline: { uz: "Ulanish yoʻq", ru: "Нет связи", en: "Offline" },
      reconnecting: { uz: "Qayta ulanmoqda…", ru: "Переподключение…", en: "Reconnecting…" },
      offlineBanner: { uz: "Internet aloqasi uzildi. Boshqalar sizni koʻrmayapti — ulanish tiklanishi bilan davom etadi.", ru: "Связь потеряна. Вас не видят другие — продолжим, как только связь восстановится.", en: "Connection lost. Others can’t see you — we’ll resume as soon as you’re back online." },
      invisibleDriver: { uz: "Siz koʻrinmaysiz — Erkin rejimni yoqing", ru: "Вас не видно — включите свободный режим", en: "You’re hidden — turn on Free Mode" },
      invisiblePassenger: { uz: "Sizni koʻrishlari uchun marshrut yarating", ru: "Постройте маршрут, чтобы вас видели", en: "Create a route so drivers can see you" },
      nobodyDrivers: { uz: "Hozircha yaqin atrofda haydovchi yoʻq", ru: "Рядом пока нет водителей", en: "No drivers nearby right now" },
      nobodyPassengers: { uz: "Hozircha yaqin atrofda yoʻlovchi yoʻq", ru: "Рядом пока нет пассажиров", en: "No passengers nearby right now" },
      nobodyHint: { uz: "Yangi walker qoʻshilsa, sizga xabar beramiz.", ru: "Сообщим, когда кто-то появится.", en: "We’ll let you know when someone appears." },
      locationOffTitle: { uz: "Joylashuvingiz aniqlanmadi", ru: "Местоположение не определено", en: "Your location is unknown" },
      locationOffBody: { uz: "Masofalar va navigatsiya ishlashi uchun joylashuvga ruxsat bering.", ru: "Разрешите доступ к геолокации для расстояний и навигации.", en: "Allow location access for distances and navigation." },
      locationRetry: { uz: "Ruxsat berish", ru: "Разрешить", en: "Allow" },
    ...
    saved: {
      openChat: { uz: "Yozish", ru: "Написать", en: "Message" },
      confirmClearBody: { uz: "Barcha saqlangan elementlar oʻchiriladi.", ru: "Все сохранённые элементы будут удалены.", en: "All saved items will be removed." },
      emptyTitle: { uz: "Saqlanganlar boʻsh", ru: 'Сохранённое пусто', en: 'No saved items' },
      emptyBody: { uz: "Walker profilidagi yulduzcha (★) bilan hamrohlarni saqlang — keyin ularga bir bosishda yozasiz.", ru: "Сохраняйте попутчиков звёздочкой (★) в их профиле — потом им можно написать в одно касание.", en: "Save riders with the star (★) on their profile — then message them in one tap." },
      count:      { uz: '{n} ta saqlangan', ru: 'Сохранено: {n}', en: '{n} saved' },
      countSub: { uz: "Saqlangan hamrohlar va joylar", ru: "Сохранённые попутчики и места", en: "Saved riders and places" },
    ...
    history: {
      emptyTitle: { uz: "Hali sayohat yoʻq", ru: "Поездок пока нет", en: "No trips yet" },
      emptyBody: { uz: "Yakunlangan sayohatlaringiz shu yerda koʻrinadi.", ru: "Здесь появятся ваши завершённые поездки.", en: "Your completed trips will appear here." },
      noPartner: { uz: "Hamroh belgilanmagan", ru: "Попутчик не отмечен", en: "No companion recorded" },
      yourRating: { uz: "Siz qoʻygan baho", ru: "Ваша оценка", en: "Your rating" },
    ...
    form: {
      pastTime: { uz: "Tanlangan vaqt oʻtib ketgan — keyinroq vaqtni tanlang", ru: "Выбранное время уже прошло — выберите позже", en: "That time has already passed — pick a later one" },
      duplicate: { uz: "Bu trip allaqachon eʼlon qilingan", ru: "Эта поездка уже опубликована", en: "This trip is already published" },
      seatsNote: { uz: "Boʻsh oʻrinlar: {n}", ru: "Свободных мест: {n}", en: "Free seats: {n}" },
      windowNote: { uz: "Joʻnash oraligʻi: {from}–{to}", ru: "Отправление: {from}–{to}", en: "Departure window: {from}–{to}" },
      searchFailed: { uz: "Manzil qidiruvi hozir ishlamayapti — birozdan soʻng qayta urinib koʻring", ru: "Поиск адреса сейчас недоступен — попробуйте чуть позже", en: "Address search is unavailable right now — try again shortly" },
      noMatches: { uz: "Bunday manzil topilmadi", ru: "Адрес не найден", en: "No matching address" },
    ...
    schedule: {
      ...
      addedBody: { uz: "Tripingiz rejalashtirilgan triplar doskasida koʻrinadi. Uni menyudagi «Mening triplarim» boʻlimida boshqarasiz.", ru: "Поездка появилась на доске запланированных поездок. Управлять ею можно в меню, в разделе «Мои поездки».", en: "Your trip is now on the planned-trips board. Manage it from “My trips” in the menu." },
    ...
    drawer: {
      myTrips: { uz: "Mening triplarim", ru: "Мои поездки", en: "My trips" },
      myTripsSub: { uz: "Eʼlon qilingan sayohatlarni koʻrish va bekor qilish", ru: "Просмотр и отмена опубликованных поездок", en: "Review and cancel what you published" },
      exitConfirmTitle: { uz: "Rolni almashtirasizmi?", ru: "Сменить роль?", en: "Switch role?" },
      exitConfirmBody: { uz: "Faol marshrutingiz bekor qilinadi va jonli ulashish toʻxtaydi.", ru: "Активный маршрут будет отменён, трансляция местоположения остановится.", en: "Your active route will be cancelled and live sharing stops." },
      exitConfirmBtn: { uz: "Almashtirish", ru: "Сменить", en: "Switch" },
      close: { uz: "Menyuni yopish", ru: "Закрыть меню", en: "Close menu" },
      menu:         { uz: 'Menyu', ru: 'Меню', en: 'Menu' },
      ...
      busy:         { uz: 'Bandman', ru: 'Я занят', en: 'Busy' },
      busyOn:       { uz: "Qidiruvda ko‘rinmayapsiz", ru: 'Вас не видно в поиске', en: 'Hidden from discovery' },
      busyOff:      { uz: "Qidiruvda ko‘rinasiz", ru: 'Вас видно в поиске', en: 'Visible in discovery' },
      busyNoTrip:   { uz: 'Avval sayohat yarating', ru: 'Сначала создайте поездку', en: 'Create a trip first' },
      ...
      exit: { uz: "Rolni almashtirish", ru: "Сменить роль", en: "Switch role" },
    },

    complaint: {
      requirements: { uz: "Mavzu kamida 3, tafsilot kamida 10 belgidan iborat boʻlsin.", ru: "Тема — не меньше 3 символов, описание — не меньше 10.", en: "Subject needs at least 3 characters, details at least 10." },
      discardTitle: { uz: "Yozganlaringiz saqlanmaydi", ru: "Введённое не сохранится", en: "Your text won’t be saved" },
      discardBody: { uz: "Shikoyat yuborilmagan. Chiqib ketasizmi?", ru: "Жалоба не отправлена. Выйти?", en: "The complaint hasn’t been sent. Leave anyway?" },
      discardBtn: { uz: "Chiqish", ru: "Выйти", en: "Leave" },
    ...
    contacts: {
      tabContacts: { uz: "Kontaktlar", ru: "Контакты", en: "Contacts" },
      tabChats: { uz: "Suhbatlar", ru: "Чаты", en: "Chats" },
      emptyTitle: { uz: "Kontaktlar yoʻq", ru: "Контактов нет", en: "No contacts yet" },
      emptyBody: { uz: "Walker profilida yoki qoʻngʻiroqdan keyin «Kontaktlarga qoʻshish» tugmasini bosing.", ru: "Нажмите «Добавить в контакты» в профиле попутчика или после звонка.", en: "Tap “Add to contacts” on a rider’s profile or after a call." },
      noResults: { uz: "Hech kim topilmadi", ru: "Никого не найдено", en: "Nobody found" },
      removeFailed: { uz: "Kontaktni oʻchirib boʻlmadi. Qayta urinib koʻring.", ru: "Не удалось удалить контакт. Попробуйте ещё раз.", en: "Couldn’t remove the contact. Please try again." },
      noLocation: { uz: "Joylashuvini ulashmayapti", ru: "Не делится местоположением", en: "Not sharing location" },
      add: { uz: "Kontaktlarga qoʻshish", ru: "Добавить в контакты", en: "Add to contacts" },
      added: { uz: "Kontaktlarga qoʻshildi", ru: "Добавлен в контакты", en: "Added to contacts" },
      already: { uz: "Allaqachon kontaktlaringizda", ru: "Уже в ваших контактах", en: "Already in your contacts" },
      addFailed: { uz: "Kontaktga qoʻshib boʻlmadi", ru: "Не удалось добавить в контакты", en: "Couldn’t add the contact" },
    ...
    chat: {
      ...
      historyFailed: { uz: "Suhbat tarixini yuklab boʻlmadi", ru: "Не удалось загрузить историю", en: "Couldn’t load the conversation" },
      empty: { uz: "Hali xabar yoʻq — birinchi boʻlib yozing", ru: "Сообщений пока нет — напишите первым", en: "No messages yet — say hello" },
      you: { uz: "Siz: ", ru: "Вы: ", en: "You: " },
      inboxEmptyTitle: { uz: "Suhbatlar yoʻq", ru: "Чатов пока нет", en: "No chats yet" },
      inboxEmptyBody: { uz: "Walker profilidagi «Chat» tugmasi orqali yozing.", ru: "Напишите попутчику через кнопку «Чат» в его профиле.", en: "Message a rider with the “Chat” button on their profile." },
      newFrom: { uz: "{name}dan yangi xabar", ru: "Новое сообщение от {name}", en: "New message from {name}" },
      reply: { uz: "Javob berish", ru: "Ответить", en: "Reply" },
      send: { uz: "Xabarni yuborish", ru: "Отправить сообщение", en: "Send message" },
    ...
    dashboard: {
      loadFailed: { uz: "Statistikani yuklab boʻlmadi", ru: "Не удалось загрузить статистику", en: "Couldn’t load statistics" },
    ...
    route: {
      serviceDown: { uz: "Marshrut xizmati javob bermadi", ru: "Сервис маршрутов не ответил", en: "The routing service didn’t respond" },
      serviceDownBody: { uz: "Manzillaringiz saqlandi. Qayta urinib koʻring yoki manzillarni oʻzgartiring.", ru: "Адреса сохранены. Повторите попытку или измените адреса.", en: "Your addresses are kept. Try again or change them." },
      editAddresses: { uz: "Manzillarni oʻzgartirish", ru: "Изменить адреса", en: "Change addresses" },
      noneBody: { uz: "Bu nuqtalar orasida avtomobil yoʻli topilmadi.", ru: "Между этими точками не найдено дороги.", en: "No drivable road was found between these points." },
      ...
      none:        { uz: 'Marshrut topilmadi', ru: 'Маршрут не найден', en: 'No route found' },
    ...
    nav2: { // active route navbar
      endConfirmTitle: { uz: "Sayohatni yakunlaysizmi?", ru: "Завершить поездку?", en: "Finish this trip?" },
      endConfirmBody: { uz: "Marshrut yopiladi, jonli ulashish toʻxtaydi va sayohat tarixga yakunlangan deb yoziladi.", ru: "Маршрут закроется, трансляция остановится, а поездка попадёт в историю как завершённая.", en: "The route closes, live sharing stops and the trip is saved to your history as completed." },
      endBtn: { uz: "Yakunlash", ru: "Завершить", en: "Finish" },
      keepBtn: { uz: "Davom etish", ru: "Продолжить", en: "Keep going" },
      gpsWaiting: { uz: "GPS signali kutilmoqda — joylashuvga ruxsat berilganini tekshiring", ru: "Ждём сигнал GPS — проверьте доступ к геолокации", en: "Waiting for GPS — check that location access is allowed" },
    ...
    call: {
      offerIncoming: { uz: "{name} birga ketishni taklif qilmoqda", ru: "{name} предлагает поехать вместе", en: "{name} suggests riding together" },
      offerAccept: { uz: "Qabul qilish", ru: "Принять", en: "Accept" },
      offerDecline: { uz: "Rad etish", ru: "Отклонить", en: "Decline" },
      offerDeclined: { uz: "{name} taklifni rad etdi", ru: "{name} отклонил(а) предложение", en: "{name} declined the offer" },
      offlineTitle: { uz: "{name} hozir oflayn", ru: "{name} сейчас не в сети", en: "{name} is offline right now" },
      offlineBody: { uz: "Xabar yozing — u Telegram orqali xabardor qilinadi.", ru: "Напишите сообщение — мы уведомим его(её) в Telegram.", en: "Send a message — they’ll be notified in Telegram." },
      ...
      agreeBtn: { uz: "Birga ketishni taklif qilish", ru: "Предложить поехать вместе", en: "Offer to ride together" },
      offerHint: { uz: "Yoʻnalishingiz bir xil boʻlsa, birga ketishni taklif qiling — ikkalangiz ham tasdiqlashingiz kerak.", ru: "Если вам по пути — предложите поехать вместе; подтвердить должны оба.", en: "Going the same way? Offer to ride together — you both have to confirm." },
      offerPending:{ uz: 'Taklif yuborildi · javob kutilmoqda', ru: 'Предложение отправлено · ожидание ответа', en: 'Offer sent · awaiting reply' },
      agreedTitle: { uz: "Kelishildi 🤝", ru: "Договорились 🤝", en: "It’s agreed 🤝" },
      agreedSub: { uz: "{name} kontaktlaringizga qoʻshildi va sayohat yakunida hamroh sifatida belgilanadi.", ru: "{name} добавлен(а) в контакты и будет отмечен(а) попутчиком по завершении поездки.", en: "{name} was added to your contacts and will be recorded as your companion when the trip ends." },
    },
    ...
    push: {
      ...
      rideAgreedTitle: { uz: "Kelishildi 🤝", ru: "Договорились 🤝", en: "It’s agreed 🤝" },
      rideAgreedBody: { uz: "{name} bilan birga ketishga kelishdingiz", ru: "Вы договорились поехать с {name}", en: "You agreed to ride with {name}" },
    },
    errors: {
      generic: { uz: "Nimadir notoʻgʻri ketdi. Qayta urinib koʻring.", ru: "Что-то пошло не так. Попробуйте ещё раз.", en: "Something went wrong. Please try again." },
      network: { uz: "Internet aloqasi yoʻq. Ulanishni tekshirib, qayta urinib koʻring.", ru: "Нет подключения к интернету. Проверьте связь и повторите.", en: "No internet connection. Check your connection and try again." },
      timeout: { uz: "Server uzoq javob bermadi. Qayta urinib koʻring.", ru: "Сервер долго не отвечает. Попробуйте ещё раз.", en: "The server took too long to respond. Please try again." },
      session: { uz: "Sessiya tugadi. Qayta kiring.", ru: "Сеанс истёк. Войдите снова.", en: "Your session has ended. Please sign in again." },
      validation: { uz: "Maʼlumotlarda xato bor. Maydonlarni tekshiring.", ru: "В данных есть ошибка. Проверьте поля.", en: "Some details are invalid. Please check the fields." },
      forbidden: { uz: "Bu amalni bajarishga ruxsatingiz yoʻq.", ru: "У вас нет прав на это действие.", en: "You’re not allowed to do that." },
      notFound: { uz: "Maʼlumot topilmadi — u oʻchirilgan boʻlishi mumkin.", ru: "Данные не найдены — возможно, они удалены.", en: "Not found — it may have been removed." },
      conflict: { uz: "Bu amal allaqachon bajarilgan.", ru: "Это действие уже выполнено.", en: "That’s already been done." },
      serviceDown: { uz: "Xizmat vaqtincha ishlamayapti. Birozdan soʻng urinib koʻring.", ru: "Сервис временно недоступен. Попробуйте чуть позже.", en: "The service is temporarily unavailable. Try again shortly." },
      server: { uz: "Serverda xatolik. Birozdan soʻng qayta urinib koʻring.", ru: "Ошибка сервера. Попробуйте чуть позже.", en: "Server error. Please try again shortly." },
      openInTelegram: { uz: "Ilovani Telegram ichidan oching — kirish Telegram hisobingiz orqali amalga oshadi.", ru: "Откройте приложение в Telegram — вход выполняется через ваш аккаунт Telegram.", en: "Open the app from Telegram — you sign in with your Telegram account." },
      userOffline: { uz: "Foydalanuvchi hozir oflayn. Unga xabar yozing.", ru: "Пользователь не в сети. Напишите ему сообщение.", en: "This user is offline. Send them a message instead." },
      realtimeOffline: { uz: "Ulanish yoʻq. Internet tiklanishini kuting.", ru: "Нет соединения. Дождитесь восстановления интернета.", en: "Not connected. Wait for the connection to return." },
      micDenied: { uz: "Mikrofonga ruxsat bering: Telegram / telefon sozlamalarida mikrofonni yoqing.", ru: "Разрешите доступ к микрофону в настройках Telegram / телефона.", en: "Allow microphone access in your Telegram / phone settings." },
      noMic: { uz: "Mikrofon topilmadi yoki band.", ru: "Микрофон не найден или занят.", en: "No microphone found, or it is in use." },
      loadFailed: { uz: "Maʼlumotlarni yuklab boʻlmadi.", ru: "Не удалось загрузить данные.", en: "Couldn’t load the data." },
      sendFailed: { uz: "Yuborib boʻlmadi.", ru: "Не удалось отправить.", en: "Couldn’t send." },
    },
    time: {
      justNow: { uz: "hozirgina", ru: "только что", en: "just now" },
      minutesAgo: { uz: "{n} daq oldin", ru: "{n} мин назад", en: "{n} min ago" },
      todayAt: { uz: "bugun {time}", ru: "сегодня в {time}", en: "today {time}" },
      yesterdayAt: { uz: "kecha {time}", ru: "вчера в {time}", en: "yesterday {time}" },
    },
    session: {
      title: { uz: "Sessiya tugadi", ru: "Сеанс завершён", en: "Session ended" },
      body: { uz: "Xavfsizlik uchun qayta kirish kerak. Qayta urinib koʻring; agar yordam bermasa, ilovani yopib Telegram’dan qayta oching.", ru: "Для безопасности нужно войти снова. Повторите попытку; если не поможет — закройте приложение и откройте его из Telegram.", en: "For your security you need to sign in again. Retry; if that doesn’t help, close the app and reopen it from Telegram." },
      retry: { uz: "Qayta kirish", ru: "Войти снова", en: "Sign in again" },
      closeApp: { uz: "Ilovani yopish", ru: "Закрыть приложение", en: "Close the app" },
    },
    myTrips: {
      title: { uz: "Mening triplarim", ru: "Мои поездки", en: "My trips" },
      emptyTitle: { uz: "Faol trip yoʻq", ru: "Активных поездок нет", en: "No active trips" },
      emptyBody: { uz: "Rejalashtirilgan sayohat qoʻshish uchun pastdagi «Rejalashtir» boʻlimini oching.", ru: "Чтобы запланировать поездку, откройте раздел «Планировщик» внизу.", en: "To plan a trip, open “Schedule” in the bottom bar." },
      planned: { uz: "Rejalashtirilgan", ru: "Запланирована", en: "Planned" },
      live: { uz: "Jonli marshrut", ru: "Живой маршрут", en: "Live route" },
      liveHint: { uz: "Xaritadagi marshrut panelidan yakunlanadi", ru: "Завершается на панели маршрута на карте", en: "Finish it from the route bar on the map" },
      hidden: { uz: "Qidiruvdan yashirilgan", ru: "Скрыта из поиска", en: "Hidden from search" },
      cancel: { uz: "Bekor qilish", ru: "Отменить", en: "Cancel trip" },
      cancelConfirmTitle: { uz: "Tripni bekor qilasizmi?", ru: "Отменить поездку?", en: "Cancel this trip?" },
      cancelConfirmBody: { uz: "U rejalashtirilgan triplar doskasidan olib tashlanadi. Buni qaytarib boʻlmaydi.", ru: "Она исчезнет с доски запланированных поездок. Это нельзя отменить.", en: "It will be removed from the planned-trips board. This can’t be undone." },
      cancelled: { uz: "Trip bekor qilindi", ru: "Поездка отменена", en: "Trip cancelled" },
      driverRole: { uz: "Haydovchi sifatida", ru: "Как водитель", en: "As driver" },
      passengerRole: { uz: "Yoʻlovchi sifatida", ru: "Как пассажир", en: "As passenger" },
    },
  };
